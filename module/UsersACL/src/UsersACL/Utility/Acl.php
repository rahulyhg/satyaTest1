...
class Acl extends ZendAcl
{
    ...
    public function __construct(\UsersACL\Model\Role $table1,
 \UsersACL\Model\UserRole $table2,
 \UsersACL\Model\PermissionTable $table3,
 \UsersACL\Model\ResourceTable $table4,
 \UsersACL\Model\RolePermissionTable $table5
            )
    {
        $this->roleTable = $table1;
                $this->userRoleTable = $table2;
                $this->permissionTable = $table3;
                $this->resourceTable = $table4;
                $this->rolePermissionTable = $table5;
    }
    ...
    {
        $roleTable = $this->roleTable->getUserRoles();
        //\Doctrine\Common\Util\Debug::dump($roleTable);exit;
        return $roleTable;
    }
    ...
    {
        //$resourceTable = $this->roleTable()->get("ResourceTable");
        return $this->resourceTable->getAllResources();
    }
    ...
    protected function _getRolePermissions()
    {
        ...
        return $this->rolePermissionTable->getRolePermissions();
    }
