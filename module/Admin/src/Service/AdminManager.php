...
class AdminManager
{
    ...
    public function addAdmin($data) 
    {
        ...
        if($this->checkAdminExists($data['email'])) {
            throw new \Exception("Admin with email address " . $data['$email'] . " already exists");
        }
    ...
    public function updateAdmin($user, $data) 
    {
        ...
        if($user->getEmail()!=$data['email'] && $this->checkAdminExists($data['email'])) {
     ...
     */
    public function createAdminAdminIfNotExists()
    {
        ...
        if ($user==null) {
            ...
            $user->setPassword($passwordHash);
            $user->setStatus(Admin::STATUS_ACTIVE);
