...
class AdminController extends AbstractActionController 
{
    ...
    {
        // Create user form
        $form = new AdminForm('create', $this->entityManager);
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Add user.
                $user = $this->userManager->addAdmin($data);
    ...
    public function editAction() 
    {
        ...
        // Create user form
        $form = new AdminForm('update', $this->entityManager, $user);
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if($form->isValid()) {
                ...
                // Update the user.
                $this->userManager->updateAdmin($user, $data);
